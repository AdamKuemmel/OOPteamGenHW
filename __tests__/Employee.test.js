...
describe("employee", () => {
  describe("Initialization", () => {
    it("should create an object with name, id and email", () => {
      //arrange    act
      const emplo = new Employee("bruce", 111, "adamkuemmel@gmail.com");
    ...
    it("should throw an err if name isnt a string", () => {
      const emp = () => new Employee(111, 111, "a@gmail.com");
      expect(emp).toThrow();
    });
    it("should throw an err if id isnt a number", () => {
      const emp = () => new Employee("bruce", "111", "a@gmail.com");
      expect(emp).toThrow();
    });
    ...
    it("should throw an err if email isnt an email", () => {
      const emp = () => new Employee("bruce", 111, 111);
      expect(emp).toThrow();
    });
  });
  describe("getName()", () => {
    it("should return the value of this.name", () => {
      const name = new Employee("bruce", 111, "a@gmail.com");
  ...
  describe("getId()", () => {
    it("should return the value of tthis.id", () => {
      const id = new Employee("bruce", 111, "a@gmail.com");
      const testId = id.id;
  ...
  describe("getEmail()", () => {
    it("should return the value of this.name", () => {
      const email = new Employee("bruce", 111, "a@gmail.com");
  ...
  describe("getRole()", () => {
    it("should return the value of this.name", () => {
      const role = new Employee("bruce", 111, "a@gmail.com");
